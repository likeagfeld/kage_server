...

{
  ...
  dVar8 = (double)(*(code *)PTR_FID_conflict__atan2f_8c043ae0)(CONCAT44(local_c,SUB84(dVar8,0)));
  if (in_FPSCR_SZ == '\0') {
    dVar9 = (double)CONCAT44(DAT_8c043ae4,uVar4);
  }
  else {
    dVar9 = (double)CONCAT44(PTR__njRotateZ_8c043ae8,DAT_8c043ae4);
  }
  if (in_FPSCR_PR == '\0') {
    dVar8 = (double)CONCAT44((float)((ulonglong)dVar8 >> 0x20) * (float)((ulonglong)dVar9 >> 0x20),
                             SUB84(dVar8,0));
  ...
  (*(code *)PTR__njRotateZ_8c043ae8)(iVar6,iVar2);
  return;
}
