...

{
  ...
  *(uint **)(puVar18 + iVar8 + 0x4c) = param_3;
  if ((*param_3 & 4) == 0) {
    if (param_6 == -1) {
      *(undefined **)(puVar18 + iVar8 + 0x50) = PTR__strlen_8c046c14;
      uVar6 = (*(code *)PTR__strlen_8c046c14)(param_4);
      *(undefined4 *)(*(int *)(puVar18 + iVar8 + 0x4c) + 0x10) = uVar6;
    }
    else {
      *(undefined **)(puVar18 + iVar8 + 0x50) = PTR__strlen_8c0468a4;
      *(int *)(*(int *)(puVar18 + iVar8 + 0x4c) + 0x10) = param_6;
    }
    iVar14 = *(int *)(puVar18 + iVar8 + 0x4c);
    iVar10 = 0;
    uVar6 = (*(code *)PTR__malloc_8c0468a8)(*(int *)(iVar14 + 0x10) + 1);
    puVar4 = PTR__malloc_8c0468a8;
    *(undefined4 *)(iVar14 + 0xc) = uVar6;
    uVar6 = (*(code *)puVar4)(*(int *)(iVar14 + 0x10) << 2);
    puVar4 = PTR__malloc_8c0468a8;
    *(undefined4 *)(iVar14 + 4) = uVar6;
    uVar6 = (*(code *)puVar4)(*(int *)(iVar14 + 0x10) << 2);
    puVar4 = PTR__memset_8c0468ac;
    *(undefined4 *)(iVar14 + 8) = uVar6;
    (*(code *)puVar4)(*(undefined4 *)(iVar14 + 4),0,*(int *)(iVar14 + 0x10) << 2);
    (*(code *)PTR__memset_8c0468ac)(*(undefined4 *)(iVar14 + 8),0,*(int *)(iVar14 + 0x10) << 2);
    uVar9 = (uint)in_dr14;
