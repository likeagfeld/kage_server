    ...
    do {
      ...
      *(int *)((int)puVar16 + -0x20) = iVar14;
      if (cVar1 == '\x04') {
        ...
        if (iVar14 == 3) {
          ...
          if ((iVar14 != 0) && (*(int *)(iVar14 + 0x24) != 1)) {
            *(byte *)(iVar13 + 3) = *(byte *)(iVar13 + 3) & 0xf | (byte)DAT_8c0735f4;
            ...
            (*(code *)PTR___bfswu_8c0735fc)(uVar15,(int)DAT_8c0735f6);
        ...
        *(undefined **)((int)puVar16 + -0x18) = PTR___bfswu_8c073484;
        *(undefined **)((int)puVar16 + -0xc) = PTR___bfswu_8c073484;
        (*(code *)PTR___bfswu_8c073484)(4);
