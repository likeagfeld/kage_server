...

{
  ...
  *(byte *)(iVar2 + 3) = *(byte *)(iVar2 + 3) & 0xf | 0x40;
  ...
  (*(code *)PTR___bfswu_8c0793d8)(uVar1,unaff_r14 + unaff_r11 * 6,6);
  uVar1 = (*(code *)PTR_FUN_8c0793d4)((int)DAT_8c0793ca);
  (*(code *)PTR___bfswu_8c0793d8)(uVar1,(int)DAT_8c0793ca);
  (*(code *)PTR___bfswu_8c0793d8)(param_1,unaff_r14 + unaff_r11 * 6 + 2,(int)DAT_8c0793ce);
