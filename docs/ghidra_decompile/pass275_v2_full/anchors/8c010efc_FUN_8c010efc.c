  ...
  if ((*param_4 & 1) != 0) {
    if ((*param_4 & 2) != 0) {
      *(int *)((int)puVar3 + -0xc) = *(int *)(param_4[1] + 0x14) + 0x10;
      (*(code *)PTR__njUnitMatrix_8c011060)();
      (*(code *)PTR__njTranslateV_8c011064)(*(undefined4 *)((int)puVar3 + -0xc),param_4 + 0x13);
      if ((*param_4 & 4) != 0) {
        if (in_FPSCR_SZ == '\0') {
        ...
        (*(code *)PTR__njMultiMatrix_8c011074)(*(undefined4 *)((int)puVar3 + -0xc),DAT_8c011070);
        if (in_FPSCR_SZ == '\0') {
      ...
      (*(code *)PTR__njScaleV_8c01108c)(*(undefined4 *)((int)puVar3 + -0xc),param_4 + 0x19);
