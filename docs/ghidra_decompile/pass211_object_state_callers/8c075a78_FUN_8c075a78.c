...
LAB_8c075ec2:
        ...
        if ((((iVar7 == 0xf) && (cVar1 = (char)puVar16[4], cVar1 != '\x02')) && (cVar1 != '\x03'))
          ...
          *(byte *)(iVar18 + 3) = *(byte *)(iVar18 + 3) & (byte)uVar4;
          ...
          (*(code *)PTR_FUN_8c075e24)(uVar9,6);
          uVar9 = (*(code *)puVar3)(iVar14 + iVar17 * 4,iVar7);
          (*(code *)PTR_FUN_8c075e24)(uVar9,iVar7);
          (*(code *)PTR_FUN_8c075e24)
                    (-(((*(byte *)(iVar14 + iVar17 * 4) & 0x10) == 0) - 1),(int)DAT_8c075e18);
          (*(code *)PTR_FUN_8c075e24)(*(byte *)(iVar14 + iVar17 * 4) & 0xf,(int)DAT_8c075e1a);
          ...
          *(ushort **)((int)puVar20 + -0x24) = puVar16 + 1;
          ...
          (*(code *)PTR_FUN_8c075e24)(*(undefined4 *)((int)puVar20 + -0x24),uVar9,iVar7);
          *(byte *)(puVar16 + 1) =
