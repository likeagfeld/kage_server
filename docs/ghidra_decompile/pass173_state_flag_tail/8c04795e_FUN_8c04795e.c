// entry: 8c04795e
// name: FUN_8c04795e
// signature: undefined FUN_8c04795e(void)


/* WARNING: Removing unreachable block (ram,0x8c04762c) */

void FUN_8c04795e(undefined4 param_1,int param_2,uint *param_3,int param_4,int param_5,int param_6,
...

{
  ...
  iStack00000060 = param_19 + (int)DAT_8c0479f6;
  if (in_FPSCR_SZ == '\0') {
    dVar7 = (double)CONCAT44(unaff_r11[1],param_1);
  }
  else {
    dVar7 = *(double *)(unaff_r11 + 1);
  }
  if (in_FPSCR_PR == '\0') {
    iVar12 = (int)(float)((ulonglong)dVar7 >> 0x20);
  }
  else {
    iVar12 = (int)dVar7;
  }
  if (*(int *)(param_24 * 4 + iStack00000060 + DAT_8c0479f8) <= iVar12) {
    if (in_FPSCR_SZ == '\0') {
      dVar7 = (double)CONCAT44(unaff_r11[2],SUB84(dVar7,0));
    }
    else {
      dVar7 = *(double *)(unaff_r11 + 2);
    }
    if (in_FPSCR_PR == '\0') {
      iVar12 = (int)(float)((ulonglong)dVar7 >> 0x20);
    }
    ...
    if ((iVar12 == 0) && ((*(byte *)(DAT_8c0479fa + iStack00000060) & 0x40) == 0)) {
      unaff_r11 = unaff_r11 + 3;
    }
    else if ((iVar12 == 1) && ((*(byte *)(DAT_8c0479fa + iStack00000060) & 0x40) != 0)) {
      unaff_r11 = unaff_r11 + 3;
    }
  }
  while( true ) {
    while( true ) {
              ...
              while( true ) {
                while( true ) {
                  while( true ) {
                                          ...
                                          do {
                                            ...
                                            if (*unaff_r11 == 1) {
                                              ...
                                              *(uint *)((int)&param_3 + (int)DAT_8c0473f0) = uVar10;
                                              ...
                                              iVar12 = uVar4 * 2;
                                              sVar1 = *(short *)(iVar12 + iVar11 + DAT_8c047400);
                                              *(short *)(iVar11 + DAT_8c047400 + iVar12) =
                                                   *(short *)(iVar12 + iVar11 + DAT_8c047400) + 1;
                                              *(short *)(iVar11 + iVar5 + uVar4 * 8 + sVar1 * 2) =
                                                   (short)uVar6 + 0xe;
                                            }
                                            do {
                                              param_9 = param_9 + -1;
                    ...
                    if (in_FPSCR_PR == '\0') {
                      uVar10 = (uint)(float)((ulonglong)dVar7 >> 0x20);
                    }
                    else {
                      uVar10 = (uint)dVar7;
                    }
                  ...
                  if (in_FPSCR_PR == '\0') {
                    bVar9 = fVar8 < (float)((ulonglong)dVar7 >> 0x20);
                  }
                  else {
                    bVar9 = in_dr14 < dVar7;
                  }
                ...
                if (in_FPSCR_PR == '\0') {
                  bVar9 = (float)((ulonglong)dVar7 >> 0x20) < fVar8;
                }
                else {
                  bVar9 = dVar7 < in_dr14;
                }
      ...
      if (unaff_r12 == 0x12) {
        ...
        iVar12 = param_19 + (int)DAT_8c047700;
        if (in_FPSCR_PR == '\0') {
        ...
        *(int *)((int)&param_3 + (int)DAT_8c047706) = iVar12;
        uVar10 = param_24;
        *(int *)((int)&param_3 + (int)DAT_8c047708) = param_26;
        *(int *)((int)&param_3 + (int)DAT_8c04770a) = iVar12 + DAT_8c047702;
        *(int *)((int)&param_3 + (int)DAT_8c04770c) = param_26;
        *(int *)((int)&param_3 + (int)DAT_8c04770e) = iVar12 + DAT_8c047704;
        ...
        *(int *)((int)&param_3 + (int)DAT_8c04770e) = iVar5;
        ...
        if (in_FPSCR_PR == '\0') {
          iVar11 = (int)(float)((ulonglong)dVar7 >> 0x20);
        }
        else {
          iVar11 = (int)dVar7;
        }
        if ((int)sVar1 + (int)sVar2 + (int)*(short *)(iVar12 * 2 + iVar5) == iVar11) {
          unaff_r11 = unaff_r11 + 3;
        }
      }
      else if (unaff_r12 == 0x13) {
        iVar12 = param_19 + (int)DAT_8c04786e;
        *(int *)((int)&param_3 + (int)DAT_8c047870) = iVar12;
        if (in_FPSCR_SZ == '\0') {
          dVar7 = (double)CONCAT44(unaff_r11[1],uVar6);
        }
        else {
        ...
        if (in_FPSCR_PR == '\0') {
          iVar5 = (int)(float)((ulonglong)dVar7 >> 0x20);
        }
        else {
          iVar5 = (int)dVar7;
        }
        if (*(int *)(param_24 * 4 + iVar12 + DAT_8c047872) == iVar5) {
          if (in_FPSCR_SZ == '\0') {
            dVar7 = (double)CONCAT44(unaff_r11[2],SUB84(dVar7,0));
          }
          else {
        ...
        if (iVar12 <= *(int *)(param_24 * 4 + param_32 + DAT_8c047872)) {
          if (in_FPSCR_SZ == '\0') {
            dVar7 = (double)CONCAT44(unaff_r11[2],SUB84(dVar7,0));
          }
          else {
          ...
          if ((iVar12 == 0) && ((*(byte *)(DAT_8c047874 + param_32) & 0x40) == 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
          else if ((iVar12 == 1) && ((*(byte *)(DAT_8c047874 + param_32) & 0x40) != 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
        }
      }
        ...
        if (*(int *)(param_24 * 4 + param_31 + DAT_8c047872) <= iVar12) {
          if (in_FPSCR_SZ == '\0') {
            dVar7 = (double)CONCAT44(unaff_r11[2],SUB84(dVar7,0));
          }
          else {
          ...
          if ((iVar12 == 0) && ((*(byte *)(DAT_8c047874 + param_31) & 0x40) == 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
          else if ((iVar12 == 1) && ((*(byte *)(DAT_8c047874 + param_31) & 0x40) != 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
        }
      }
        ...
        if (*(int *)(param_24 * 4 + param_30 + DAT_8c0479f8) == iVar12) {
          if (in_FPSCR_SZ == '\0') {
            dVar7 = (double)CONCAT44(unaff_r11[2],SUB84(dVar7,0));
          }
          else {
          ...
          if ((iVar12 == 0) && ((*(byte *)(DAT_8c0479fa + param_30) & 0x40) == 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
          else if ((iVar12 == 1) && ((*(byte *)(DAT_8c0479fa + param_30) & 0x40) != 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
        }
      }
        ...
        if (iVar12 <= *(int *)(param_24 * 4 + param_29 + DAT_8c0479f8)) {
          if (in_FPSCR_SZ == '\0') {
            dVar7 = (double)CONCAT44(unaff_r11[2],SUB84(dVar7,0));
          }
          else {
          ...
          if ((iVar12 == 0) && ((*(byte *)(DAT_8c0479fa + param_29) & 0x40) == 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
          else if ((iVar12 == 1) && ((*(byte *)(DAT_8c0479fa + param_29) & 0x40) != 0)) {
            unaff_r11 = unaff_r11 + 3;
          }
        }
      }
    ...
    if (in_FPSCR_PR == '\0') {
      param_28 = (int)(float)((ulonglong)dVar7 >> 0x20);
    }
    else {
      param_28 = (int)dVar7;
    }
