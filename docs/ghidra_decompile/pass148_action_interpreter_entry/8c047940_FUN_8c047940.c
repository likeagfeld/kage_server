...

{
  ...
  do {
    if ((*(byte *)(DAT_8c0479fa + param_29) & 0x40) != 0) {
    ...
    do {
      while( true ) {
                  ...
                  while( true ) {
                    while( true ) {
                      while( true ) {
                        ...
                        if (*(short *)(param_28 * 2 + param_27 + param_24 * 0x1e) != 0) {
                          FUN_8c0479f2();
                          return;
                        }
                        if (*(short *)(param_28 * 2 + param_27 + DAT_8c047702 + param_24 * 0x1e) !=
                            0) {
                          FUN_8c0479f2(param_28 * 2);
                          return;
                        }
                        if (*(short *)(param_28 * 2 + param_27 + DAT_8c047704 + param_24 * 0x1e) !=
                            0) {
                          FUN_8c0479f2(param_28 * 2);
                          return;
                        }
        ...
        } while (*(int *)(param_24 * 4 + param_29 + DAT_8c0479f8) < iVar11);
        if (in_FPSCR_SZ == '\0') {
          param_1 = (double)CONCAT44(unaff_r11[2],SUB84(param_1,0));
        }
        else {
        ...
        if ((iVar11 != 0) || ((*(byte *)(DAT_8c0479fa + param_29) & 0x40) != 0)) break;
        unaff_r11 = unaff_r11 + 3;
      }
    } while (iVar11 != 1);
  } while( true );
