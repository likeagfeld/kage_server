// entry: 8c047940
// name: FUN_8c047940
// signature: undefined FUN_8c047940(void)


void FUN_8c047940(double param_1,int param_2,uint *param_3,int param_4,int param_5,int param_6,
                 ...
                 int param_30,int param_31,int param_32,int param_33)

{
  ...
  do {
    if ((*(byte *)(DAT_8c0479fa + param_30) & 0x40) != 0) {
    ...
    do {
      while( true ) {
            ...
            while( true ) {
              while( true ) {
                while( true ) {
                  while( true ) {
                    while( true ) {
                      while( true ) {
                                    ...
                                    while( true ) {
                                      while( true ) {
                                                ...
                                                while( true ) {
                                                          ...
                                                          if (param_14 == 0) {
                                                            do {
                                                              if (param_12 != unaff_r11) {
                                                                *(int **)(param_8 * 4 + param_10) =
                                                                     unaff_r11;
                                                              }
                                                              if (*unaff_r11 == 1) {
                                                                uVar10 = param_3[2];
                                                                *(uint *)((int)&param_3 +
                                                                         (int)DAT_8c0473f0) = uVar10
                                                                ;
                                                  ...
                                                  DAT_8c0473f2) & 0x40) == 0) {
                                                    (*(code *)PTR_FUN_8c047a04)
                                                               ...
                                                               *(undefined4 *)
                                                                (param_8 * 4 +
                                                                *(int *)((int)DAT_8c0479fe +
                                                                        *(int *)((int)DAT_8c0479fc +
                                                                                uVar10)) +
                                                                (int)DAT_8c047a00));
                                                  }
                                                  else {
                                                    ...
                                                    iVar11 = uVar4 * 2;
                                                    sVar1 = *(short *)(iVar11 + iVar12 + 
                                                  DAT_8c047400);
                                                  *(short *)(iVar12 + DAT_8c047400 + iVar11) =
                                                       *(short *)(iVar11 + iVar12 + DAT_8c047400) +
                                                       1;
                                                  *(short *)(iVar12 + iVar5 + uVar4 * 8 + sVar1 * 2)
                                                  ...
                                                  unaff_r12 = param_4;
                                                  if (param_4 == 0) {
                                                    unaff_r12 = *(int *)(PTR_DAT_8c047294 +
                                                                        param_13 * 4);
                                                  }
                                        ...
                                        if (((*(byte *)((int)DAT_8c047564 +
                                                       param_19 + (int)DAT_8c047562) & 0x40) != 0)
                                           && ((*(uint *)((int)DAT_8c047566 +
                                                         param_19 + (int)DAT_8c047562) & 1) != 0)) {
                                          unaff_r11 = unaff_r11 + 3;
                                          param_12 = unaff_r11;
                                          param_2 = 1;
                                          unaff_r12 = *unaff_r11;
                        ...
                        param_28 = param_19 + (int)DAT_8c047700;
                        if (in_FPSCR_SZ == '\0') {
                          param_1 = (double)CONCAT44(unaff_r11[1],uVar6);
                        }
                        else {
                        ...
                        if (in_FPSCR_PR == '\0') {
                          param_29 = (int)(float)((ulonglong)param_1 >> 0x20);
                        }
                        else {
                          param_29 = (int)param_1;
                        }
                        if (((*(short *)(param_29 * 2 + param_28 + param_24 * 0x1e) == 0) &&
                            (*(short *)(param_29 * 2 + param_28 + DAT_8c047702 + param_24 * 0x1e) ==
                             0)) && (*(short *)(param_29 * 2 +
                                               param_28 + DAT_8c047704 + param_24 * 0x1e) == 0)) {
                          bVar9 = false;
                        }
                        else {
                          bVar9 = true;
                      ...
                      if (in_FPSCR_PR == '\0') {
                        param_27 = (int)(float)((ulonglong)dVar7 >> 0x20);
                      }
                      else {
                        param_27 = (int)dVar7;
                      }
                      *(int *)((int)&param_3 + (int)DAT_8c047706) = iVar11;
                      uVar10 = param_24;
                      *(int *)((int)&param_3 + (int)DAT_8c047708) = param_27;
                      *(int *)((int)&param_3 + (int)DAT_8c04770a) = iVar11 + DAT_8c047702;
                      *(int *)((int)&param_3 + (int)DAT_8c04770c) = param_27;
                      ...
                      if ((iVar11 == 0) &&
                        ...
                        unaff_r11 = unaff_r11 + 3;
                              ...
                              ((*(byte *)((int)DAT_8c047874 +
                                         *(int *)((int)&param_3 + (int)DAT_8c047870)) & 0x40) != 0))
                      {
                        unaff_r11 = unaff_r11 + 3;
                      }
                    }
                  }
                  if (unaff_r12 != 0x14) break;
                  param_33 = param_19 + (int)DAT_8c04786e;
                  if (in_FPSCR_SZ == '\0') {
                    param_1 = (double)CONCAT44(unaff_r11[1],uVar6);
                  }
                  else {
                  ...
                  if (iVar11 <= *(int *)(param_24 * 4 + param_33 + DAT_8c047872)) {
                    if (in_FPSCR_SZ == '\0') {
                      param_1 = (double)CONCAT44(unaff_r11[2],SUB84(param_1,0));
                    }
                    else {
                    ...
                    if ((iVar11 == 0) && ((*(byte *)(DAT_8c047874 + param_33) & 0x40) == 0)) {
                      unaff_r11 = unaff_r11 + 3;
                    }
                    else if ((iVar11 == 1) && ((*(byte *)(DAT_8c047874 + param_33) & 0x40) != 0)) {
                      unaff_r11 = unaff_r11 + 3;
                    }
                  }
                }
                if (unaff_r12 != 0x15) break;
                ...
                if (*(int *)(param_24 * 4 + param_32 + DAT_8c047872) <= iVar11) {
                  if (in_FPSCR_SZ == '\0') {
                    param_1 = (double)CONCAT44(unaff_r11[2],SUB84(param_1,0));
                  }
                  else {
              ...
              if (unaff_r12 != 0x16) break;
              param_31 = param_19 + (int)DAT_8c0479f6;
              if (in_FPSCR_SZ == '\0') {
                param_1 = (double)CONCAT44(unaff_r11[1],uVar6);
              }
              else {
              ...
              if (*(int *)(param_24 * 4 + param_31 + DAT_8c0479f8) == iVar11) {
                if (in_FPSCR_SZ == '\0') {
                  param_1 = (double)CONCAT44(unaff_r11[2],SUB84(param_1,0));
                }
                else {
                ...
                if ((iVar11 == 0) && ((*(byte *)(DAT_8c0479fa + param_31) & 0x40) == 0)) {
                  unaff_r11 = unaff_r11 + 3;
                }
                else if ((iVar11 == 1) && ((*(byte *)(DAT_8c0479fa + param_31) & 0x40) != 0)) {
                  unaff_r11 = unaff_r11 + 3;
                }
              }
            }
            if (unaff_r12 == 0x17) break;
            if (unaff_r12 == 0x18) {
              param_26 = param_19 + (int)DAT_8c0479f6;
              if (in_FPSCR_SZ == '\0') {
                param_1 = (double)CONCAT44(unaff_r11[1],uVar6);
              }
              else {
              ...
              if (*(int *)(param_24 * 4 + param_26 + DAT_8c0479f8) <= iVar11) {
                if (in_FPSCR_SZ == '\0') {
                  param_1 = (double)CONCAT44(unaff_r11[2],SUB84(param_1,0));
                }
                else {
                ...
                if ((iVar11 == 0) && ((*(byte *)(DAT_8c0479fa + param_26) & 0x40) == 0)) {
                  unaff_r11 = unaff_r11 + 3;
                }
                else if ((iVar11 == 1) && ((*(byte *)(DAT_8c0479fa + param_26) & 0x40) != 0)) {
                  unaff_r11 = unaff_r11 + 3;
                }
              }
            }
            else if (unaff_r12 == 0x19) {
              if (in_FPSCR_SZ == '\0') {
                param_1 = (double)CONCAT44(unaff_r11[1],uVar6);
              }
              else {
        ...
        } while (*(int *)(param_24 * 4 + param_30 + DAT_8c0479f8) < iVar11);
        if (in_FPSCR_SZ == '\0') {
          param_1 = (double)CONCAT44(unaff_r11[2],SUB84(param_1,0));
        }
        else {
        ...
        if ((iVar11 != 0) || ((*(byte *)(DAT_8c0479fa + param_30) & 0x40) != 0)) break;
        unaff_r11 = unaff_r11 + 3;
      }
    } while (iVar11 != 1);
  } while( true );
