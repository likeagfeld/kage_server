...
void FUN_8c01ccc8(uint param_1,uint param_2,undefined8 param_3,int param_4)

{
  ...
  *(undefined4 *)((int)puVar12 + -4) = in_PR;
  iVar9 = (int)DAT_8c01ce1a;
  iVar10 = *(int *)((int)DAT_8c01ce1c + *(int *)(DAT_8c01ce18 + param_4));
  uVar1 = *(ushort *)(param_4 + 0x54);
  (*(code *)PTR__njPushMatrixEx_8c01ce2c)();
  uVar4 = (*(code *)puVar2)();
  uVar5 = (*(code *)puVar2)();
  iVar6 = (*(code *)PTR_FUN_8c01ce34)(*(undefined4 *)(DAT_8c01ce18 + param_4),uVar4,uVar5);
  uVar13 = (uint)in_dr14;
  if (iVar6 == 0) {
    uVar4 = (*(code *)puVar2)();
    uVar17 = (ulonglong)uVar13;
    uVar5 = (*(code *)puVar2)();
    puVar2 = PTR__njTranslate_8c01cf34;
    uVar13 = (*(code *)PTR_FUN_8c01cf30)(*(undefined4 *)(DAT_8c01cf2a + param_4),uVar4,uVar5);
    if (in_FPSCR_SZ == '\0') {
      param_1 = uVar13;
    }
    *(undefined **)((int)puVar12 + -0x10) = puVar2;
    ...
    (*(code *)PTR_FUN_8c01ce38)(*(undefined4 *)(DAT_8c01ce18 + param_4),iVar6);
    uVar4 = (*(code *)puVar2)();
    puVar3 = PTR__njTranslate_8c01ce3c;
    uVar5 = (*(code *)puVar2)();
    uVar13 = (*(code *)PTR_FUN_8c01ce40)(*(undefined4 *)(DAT_8c01ce18 + param_4),uVar4,uVar5);
    uVar14 = uVar17;
    if (in_FPSCR_SZ == '\0') {
      uVar14 = (ulonglong)param_1;
    }
    *(undefined **)((int)puVar12 + -0x10) = puVar3;
    ...
    (*(code *)PTR_FUN_8c01ce44)(*(undefined4 *)(DAT_8c01ce18 + param_4),iVar6);
  }
  if (((((*(byte *)(iVar10 + iVar9 * (uint)uVar1 + 8) & 0x80) == 0) ||
       ((*(uint *)(param_4 + 0x2c) & (int)DAT_8c01ce20) != 0)) ||
      ((*(uint *)(*(int *)PTR_DAT_8c01ce48 + 0x10) & 1) == 0)) &&
     ((*(code *)PTR_FUN_8c01ce4c)(*(undefined4 *)(param_4 + 0x58)),
     *(char *)(*(int *)((int)DAT_8c01ce1c + *(int *)(DAT_8c01ce18 + param_4)) +
               (int)DAT_8c01ce1a * (uint)*(ushort *)(param_4 + 0x54) + 0x18) != '\0')) {
    (*(code *)PTR__njPushMatrixEx_8c01cf38)();
    iVar6 = (*(code *)PTR_FUN_8c01cf3c)(*(undefined4 *)(param_4 + 0x58),5);
    (*(code *)PTR__njMultiMatrix_8c01cf40)(0,iVar6 + 0x50);
    (*(code *)PTR_FUN_8c01cf44)(*(undefined4 *)(DAT_8c01cf2c + param_4));
    (*(code *)PTR__njPopMatrixEx_8c01cf48)();
    (*(code *)PTR_FUN_8c01cf4c)(*(undefined4 *)(DAT_8c01cf2c + param_4));
  }
  (*(code *)PTR_FUN_8c01ce50)(param_4);
  uVar13 = (uint)uVar16;
  if (((**(uint **)(DAT_8c01ce22 + param_4) & 4) != 0) &&
     ((*(uint *)(param_4 + 0x2c) & DAT_8c01ce54) == 0)) {
    (*(code *)PTR__njPushMatrixEx_8c01cf38)();
    ...
    iVar6 = (*(code *)PTR_FUN_8c01cf3c)(uVar5,4);
    (*(code *)PTR__njMultiMatrix_8c01cf40)(0,iVar6 + 0x50);
    uVar16 = uVar17;
    if (in_FPSCR_SZ == '\0') {
    ...
    *(code **)((int)puVar12 + -0xc) = *(code **)((int)puVar12 + -0x10);
    ...
    (*(code *)PTR__njCalcPoint_8c01cf50)
    ...
    (*(code *)PTR_FUN_8c01cf54)(uVar15,*(undefined4 *)(DAT_8c01cf2e + param_4));
    (*(code *)PTR__njPopMatrixEx_8c01cf48)();
  }
  iVar9 = param_4 + DAT_8c01ce24;
  iVar6 = (int)DAT_8c01ce26;
  iVar11 = 0;
  iVar10 = 3;
  do {
    uVar4 = (undefined4)param_3;
    if (*(int *)(iVar11 * 0x30 + iVar9 + 0x1c) != 0) {
      (*(code *)PTR__njPushMatrixEx_8c01d09c)();
      iVar7 = (*(code *)PTR_FUN_8c01d0a0)(*(undefined4 *)(param_4 + 0x58),4);
      (*(code *)PTR__njMultiMatrix_8c01d0a4)(0,iVar7 + 0x50);
      puVar2 = PTR_FUN_8c01d0a8;
      ...
      *(undefined4 *)((int)puVar12 + -0x2c) = *(undefined4 *)((int)puVar12 + -0x38);
      ...
      (*(code *)PTR__njPopMatrixEx_8c01d0ac)();
      uVar4 = (undefined4)uVar16;
      uVar5 = (undefined4)param_3;
      if ((*(int *)(iVar11 * 0x30 + iVar9 + 0x10) == 3) &&
         (iVar7 = *(int *)(param_4 + iVar6 + 0x14), iVar7 != 0)) {
        (*(code *)PTR__njPushMatrixEx_8c01d09c)();
        (*(code *)PTR__njMultiMatrix_8c01d0a4)
                  (0,*(int *)((int)DAT_8c01d096 + *(int *)(DAT_8c01d094 + param_4)) + 0x38 +
                     (int)DAT_8c01d098);
        ...
        *(code **)((int)puVar12 + -8) = *(code **)((int)puVar12 + -0x10);
        ...
        (*(code *)PTR_FUN_8c01d0b0)(iVar7,0);
        (*(code *)PTR_FUN_8c01d0b4)(iVar7,0);
        (*(code *)PTR_FUN_8c01d0b8)(iVar7);
        iVar8 = (*(code *)PTR_FUN_8c01d0bc)(*(undefined4 *)(iVar7 + 4),3);
        if (iVar8 != 0) {
          (*(code *)PTR_FUN_8c01d0c0)(iVar7);
        }
        (*(code *)PTR__njPopMatrixEx_8c01d0ac)();
      }
    }
  ...
  (*(code *)PTR__njPopMatrixEx_8c01ce58)();
  return;
}
