...

{
  ...
  *param_1 = *param_1 & 0xffff;
  ...
  if (0 < iVar16) {
    ...
    do {
      ...
      if ((((bVar11 == 0x14) || (bVar11 == 0x15)) || (bVar11 == 0x16)) ||
        ...
        uVar4 = (*(code *)PTR___modls_8c07ca84)();
        iVar14 = *(int *)((int)DAT_8c07ca62 + (int)param_1);
        (*(code *)puVar2)(uVar4);
        (*(code *)PTR___divls_8c07ca8c)();
        (*(code *)puVar2)();
        uVar4 = DAT_8c07ca68;
  ...
  puVar3 = PTR__memset_8c07c8f8;
  puVar2 = PTR__malloc_8c07c8f4;
  uVar8 = (*(code *)PTR__malloc_8c07c8f4)(iVar16);
  *(undefined4 *)((int)DAT_8c07c8ce + (int)param_1) = uVar8;
  (*(code *)puVar3)(0,iVar16);
  (*(code *)PTR__memcpy_8c07c8fc)
