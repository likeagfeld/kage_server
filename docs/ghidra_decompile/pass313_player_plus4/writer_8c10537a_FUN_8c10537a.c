...
/* WARNING: Removing unreachable block (ram,0x8c1054d4) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_8c10537a(double param_1,undefined4 param_2,int param_3)

{
  ...
  *(undefined4 *)(puVar11 + -4) = in_PR;
  ...
  uVar2 = *(undefined2 *)(PTR_DAT_8c1054f0 + 2);
  iVar9 = 5;
  *(undefined2 *)(puVar11 + -0x18) = *(undefined2 *)PTR_DAT_8c1054f0;
  *(undefined2 *)(puVar11 + -0x16) = uVar2;
  iVar4 = *piVar7;
  *(undefined2 *)(puVar11 + -0x14) = *(undefined2 *)(PTR_DAT_8c1054f0 + 4);
  iVar8 = *(int *)(param_3 + 0x38);
  *(undefined2 *)(puVar11 + -0x12) = *(undefined2 *)(PTR_DAT_8c1054f0 + 6);
  *(undefined2 *)(puVar11 + -0x10) = *(undefined2 *)(PTR_DAT_8c1054f0 + 8);
  if (in_FPSCR_SZ == '\0') {
  ...
  if (in_FPSCR_SZ == '\0') {
    in_dr12 = (double)CONCAT44(uVar17,DAT_8c1054f8);
  }
  iVar4 = **(int **)(iVar8 + 4);
  if (in_FPSCR_PR == '\0') {
  ...
  if (in_FPSCR_SZ == '\0') {
    dVar20 = (double)CONCAT44(DAT_8c1054fc,fVar18);
  }
  else {
    dVar20 = (double)CONCAT44(_DAT_8c105500,DAT_8c1054fc);
  }
  iVar8 = 0;
  if (in_FPSCR_PR == '\0') {
  ...
  *(short *)(puVar11 + -0xc) = (short)iVar4;
  if (((int)*(char *)(param_3 + 0x4b) & 0x80U) == 0) {
    ...
    if (in_FPSCR_SZ == '\0') {
      uVar14 = CONCAT44(DAT_8c105504,fVar18);
    }
    else {
      uVar14 = CONCAT44(_DAT_8c105508,DAT_8c105504);
    }
    (**(code **)(iVar4 + 0x20))(uVar14,**(int **)(param_3 + 0x2c) + *(int *)(iVar4 + 0x18));
    iVar4 = *(int *)(**(int **)(param_3 + 0x2c) + 0x78);
    if (in_FPSCR_SZ == '\0') {
      uVar14 = CONCAT44(_DAT_8c105508,(float)(int)*(short *)(puVar11 + -0xc));
    }
    else {
      uVar14 = CONCAT44(_FUN_8c10550c,_DAT_8c105508);
    }
    (**(code **)(iVar4 + 0x38))(uVar14,**(int **)(param_3 + 0x2c) + *(int *)(iVar4 + 0x30));
    (*(code *)puVar3)(**(undefined4 **)(param_3 + 0x2c));
  }
  else {
    iVar8 = (int)DAT_8c1054ec;
    if (in_FPSCR_PR == '\0') {
    ...
    if (in_FPSCR_SZ == '\0') {
      ...
      dVar20 = (double)CONCAT44(DAT_8c105504,_DAT_8c105500);
    }
    iVar9 = 5;
    iVar4 = 0;
    do {
