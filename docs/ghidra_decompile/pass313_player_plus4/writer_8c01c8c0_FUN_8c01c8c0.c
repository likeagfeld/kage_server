...
void FUN_8c01c8c0(uint param_1,uint param_2,undefined8 param_3,int param_4)

{
  ...
  *(undefined4 *)((int)puVar12 + -4) = in_PR;
  iVar9 = (int)DAT_8c01ca12;
  iVar10 = *(int *)((int)DAT_8c01ca14 + *(int *)(DAT_8c01ca10 + param_4));
  uVar1 = *(ushort *)(param_4 + 0x54);
  (*(code *)PTR__njPushMatrixEx_8c01ca24)();
  uVar4 = (*(code *)puVar2)();
  uVar5 = (*(code *)puVar2)();
  iVar6 = (*(code *)PTR_FUN_8c01ca2c)(*(undefined4 *)(DAT_8c01ca10 + param_4),uVar4,uVar5);
  uVar13 = (uint)in_dr14;
  if (iVar6 == 0) {
    uVar4 = (*(code *)puVar2)();
    uVar17 = (ulonglong)uVar13;
    uVar5 = (*(code *)puVar2)();
    puVar2 = PTR__njTranslate_8c01cb2c;
    uVar13 = (*(code *)PTR_FUN_8c01cb28)(*(undefined4 *)(DAT_8c01cb22 + param_4),uVar4,uVar5);
    if (in_FPSCR_SZ == '\0') {
      param_1 = uVar13;
    }
    *(undefined **)((int)puVar12 + -0x10) = puVar2;
    ...
    (*(code *)PTR_FUN_8c01ca30)(*(undefined4 *)(DAT_8c01ca10 + param_4),iVar6);
    uVar4 = (*(code *)puVar2)();
    puVar3 = PTR__njTranslate_8c01ca34;
    uVar5 = (*(code *)puVar2)();
    uVar13 = (*(code *)PTR_FUN_8c01ca38)(*(undefined4 *)(DAT_8c01ca10 + param_4),uVar4,uVar5);
    uVar14 = uVar17;
    if (in_FPSCR_SZ == '\0') {
      uVar14 = (ulonglong)param_1;
    }
    *(undefined **)((int)puVar12 + -0x10) = puVar3;
    ...
    (*(code *)PTR_FUN_8c01ca3c)(*(undefined4 *)(DAT_8c01ca10 + param_4),iVar6);
  }
  if (((((*(byte *)(iVar10 + iVar9 * (uint)uVar1 + 8) & 0x80) == 0) ||
       ((*(uint *)(param_4 + 0x2c) & (int)DAT_8c01ca18) != 0)) ||
      ((*(uint *)(*(int *)PTR_DAT_8c01ca40 + 0x10) & 1) == 0)) &&
     ((*(code *)PTR_FUN_8c01ca44)(*(undefined4 *)(param_4 + 0x58)),
     *(char *)(*(int *)((int)DAT_8c01ca14 + *(int *)(DAT_8c01ca10 + param_4)) +
               (int)DAT_8c01ca12 * (uint)*(ushort *)(param_4 + 0x54) + 0x18) != '\0')) {
    (*(code *)PTR__njPushMatrixEx_8c01cb30)();
    iVar6 = (*(code *)PTR_FUN_8c01cb34)(*(undefined4 *)(param_4 + 0x58),5);
    (*(code *)PTR__njMultiMatrix_8c01cb38)(0,iVar6 + 0x50);
    (*(code *)PTR_FUN_8c01cb3c)(*(undefined4 *)(DAT_8c01cb24 + param_4));
    (*(code *)PTR__njPopMatrixEx_8c01cb40)();
    (*(code *)PTR_FUN_8c01cb44)(*(undefined4 *)(DAT_8c01cb24 + param_4));
  }
  (*(code *)PTR_FUN_8c01ca48)(param_4);
  uVar13 = (uint)uVar16;
  if (((**(uint **)(DAT_8c01ca1a + param_4) & 4) != 0) &&
     ((*(uint *)(param_4 + 0x2c) & DAT_8c01ca4c) == 0)) {
    (*(code *)PTR__njPushMatrixEx_8c01cb30)();
    ...
    iVar6 = (*(code *)PTR_FUN_8c01cb34)(uVar5,4);
    (*(code *)PTR__njMultiMatrix_8c01cb38)(0,iVar6 + 0x50);
    uVar16 = uVar17;
    if (in_FPSCR_SZ == '\0') {
    ...
    *(code **)((int)puVar12 + -0xc) = *(code **)((int)puVar12 + -0x10);
    ...
    (*(code *)PTR__njCalcPoint_8c01cb48)
    ...
    (*(code *)PTR_FUN_8c01cb4c)(uVar15,*(undefined4 *)(DAT_8c01cb26 + param_4));
    (*(code *)PTR__njPopMatrixEx_8c01cb40)();
  }
  iVar9 = param_4 + DAT_8c01ca1c;
  iVar6 = (int)DAT_8c01ca1e;
  iVar11 = 0;
  iVar10 = 3;
  do {
    uVar4 = (undefined4)param_3;
    if (*(int *)(iVar11 * 0x30 + iVar9 + 0x1c) != 0) {
      (*(code *)PTR__njPushMatrixEx_8c01cc94)();
      iVar7 = (*(code *)PTR_FUN_8c01cc98)(*(undefined4 *)(param_4 + 0x58),4);
      (*(code *)PTR__njMultiMatrix_8c01cc9c)(0,iVar7 + 0x50);
      puVar2 = PTR_FUN_8c01cca0;
      ...
      *(undefined4 *)((int)puVar12 + -0x2c) = *(undefined4 *)((int)puVar12 + -0x38);
      ...
      (*(code *)PTR__njPopMatrixEx_8c01cca4)();
      uVar4 = (undefined4)uVar16;
      uVar5 = (undefined4)param_3;
      if ((*(int *)(iVar11 * 0x30 + iVar9 + 0x10) == 3) &&
         (iVar7 = *(int *)(param_4 + iVar6 + 0x14), iVar7 != 0)) {
        (*(code *)PTR__njPushMatrixEx_8c01cc94)();
        (*(code *)PTR__njMultiMatrix_8c01cc9c)
                  (0,*(int *)((int)DAT_8c01cc8e + *(int *)(DAT_8c01cc8c + param_4)) + 0x38 +
                     (int)DAT_8c01cc90);
        ...
        *(code **)((int)puVar12 + -8) = *(code **)((int)puVar12 + -0x10);
        ...
        (*(code *)PTR_FUN_8c01cca8)(iVar7,0);
        (*(code *)PTR_FUN_8c01ccac)(iVar7,0);
        (*(code *)PTR_FUN_8c01ccb0)(iVar7);
        iVar8 = (*(code *)PTR_FUN_8c01ccb4)(*(undefined4 *)(iVar7 + 4),3);
        if (iVar8 != 0) {
          (*(code *)PTR_FUN_8c01ccb8)(iVar7);
        }
        (*(code *)PTR__njPopMatrixEx_8c01cca4)();
      }
    }
  ...
  (*(code *)PTR__njPopMatrixEx_8c01ca50)();
  return;
}
