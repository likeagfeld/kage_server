// entry: 8c034d10
// name: FUN_8c034d10
// signature: undefined FUN_8c034d10(void)
    ...
    if ((bVar22) &&
      ...
      if ((bVar22) || (iVar6 = *(int *)(DAT_8c03546a + param_3), iVar6 < 1)) {
        ...
        if (in_FPSCR_SZ == '\0') {
          ...
          dVar15 = (double)CONCAT44(PTR_FUN_8c035484,DAT_8c035480);
        }
        if (in_FPSCR_PR == '\0') {
      ...
      if (!bVar22) {
        ...
        *(undefined2 *)(param_3 + DAT_8c035470 + *(int *)(iVar9 + param_3) * 2) = 0;
        puVar2 = PTR_FUN_8c035484;
        iVar12 = param_3 + iVar12;
        iVar9 = *(int *)(iVar9 + param_3);
        (*(code *)PTR_FUN_8c035484)(uVar11 & 0xffff,iVar12 + iVar9 * 2,6,0,iVar12);
        ...
        if ((bVar22) &&
           (iVar6 = (*(code *)PTR_FUN_8c035478)
                              (*(undefined4 *)(DAT_8c035468 + param_3),uVar11,local_68,uVar11,
                               iVar9 + 1), puVar2 = PTR_FUN_8c03563c, iVar6 != 0)) {
          ...
          if ((bVar22) || (iVar6 = *(int *)(DAT_8c035624 + param_3), iVar6 < 1)) {
            ...
            if (in_FPSCR_SZ == '\0') {
              ...
              dVar15 = (double)CONCAT44(PTR_FUN_8c03563c,DAT_8c035638);
            }
            if (in_FPSCR_PR == '\0') {
              fVar20 = (float)((ulonglong)dVar18 >> 0x20) + (float)((ulonglong)dVar15 >> 0x20);
              fVar17 = SUB84(dVar18,0) * fVar20;
...
LAB_8c0350f0:
        ...
        *(undefined2 *)(param_3 + DAT_8c035184 + *(int *)(DAT_8c035180 + param_3) * 2) = 5;
        puVar2 = PTR_FUN_8c0351a0;
        iVar6 = param_3 + iVar6;
        iVar4 = *(int *)(DAT_8c035180 + param_3);
        (*(code *)PTR_FUN_8c0351a0)(iVar6 + iVar4 * 2,6,uVar11 & 0xffff,iVar6);
      ...
      if (in_FPSCR_SZ == '\0') {
        ...
        dVar16 = (double)CONCAT44(PTR_FUN_8c0351a0,DAT_8c03519c);
      }
      if (in_FPSCR_PR == '\0') {
    ...
    if ((bVar22) || (iVar9 = *(int *)(DAT_8c034ea4 + param_3), iVar9 < 1)) {
      ...
      if (in_FPSCR_SZ == '\0') {
        ...
        dVar15 = (double)CONCAT44(PTR_FUN_8c034ec0,DAT_8c034ebc);
      }
      if (in_FPSCR_PR == '\0') {
        fVar20 = (float)((ulonglong)dVar18 >> 0x20) + (float)((ulonglong)dVar15 >> 0x20);
        fVar17 = SUB84(dVar18,0) * fVar20;
    ...
    if (!bVar22) {
      ...
      *(undefined2 *)(param_3 + iVar13 + *(int *)(iVar9 + param_3) * 2) = 0;
      puVar2 = PTR_FUN_8c034ec0;
      iVar9 = *(int *)(iVar9 + param_3);
      iVar12 = param_3 + iVar12;
      (*(code *)PTR_FUN_8c034ec0)(uVar11 & 0xffff,iVar12 + iVar9 * 2,6);
      uVar3 = SUB84(dVar16,0);
