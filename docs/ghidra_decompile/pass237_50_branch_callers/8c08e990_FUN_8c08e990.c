...

{
  ...
  *(undefined4 *)((int)puVar16 + -0xc) = param_7;
  (*(code *)PTR_FUN_8c08eb14)(param_5 + 0x28);
  uVar14 = (uint)in_dr14;
  iVar10 = 0;
  iVar9 = 0;
  if (param_6 == 1) {
  ...
  (*(code *)PTR_FUN_8c08eb14)(*(uint *)((int)puVar16 + -0xc) & 0xffff);
  ...
  *(undefined2 *)((int)puVar16 + -0x44) = *(undefined2 *)(param_5 + 2);
  ...
  uVar4 = (*(code *)PTR_FUN_8c08ec9c)();
  uVar17 = SUB84(dVar26,0);
  uVar22 = SUB84(dVar25,0);
  (*(code *)puVar3)(uVar4);
  (*(code *)PTR_FUN_8c08ec9c)();
  (*(code *)puVar3)();
  if ((uVar14 & 7) == 0) {
LAB_8c08ec4a:
    uVar15 = 0;
    ...
    *pbVar11 = *pbVar11 & (byte)DAT_8c08ef0a | 0x10;
    (*(code *)PTR_FUN_8c08ef20)(uVar12 & 0xf);
  }
  else {
      ...
      if ((iVar5 == 0) || ((*(byte *)(iVar5 + 9) & 0x7f) != 0)) {
        ...
        if (bVar1 == 0) {
          if (in_FPSCR_SZ == '\0') {
            ...
            dVar23 = (double)CONCAT44(PTR_FUN_8c08ef20,DAT_8c08ef1c);
          }
        }
