...

{
  ...
  *(undefined4 *)((int)puVar16 + iVar8 + 0x54) = 0;
  (*(code *)PTR_FUN_8c0912cc)(*(undefined4 *)((int)puVar16 + iVar8 + 0x44));
  ...
  *(undefined1 **)((int)puVar16 + iVar8 + 100) = (undefined1 *)((int)puVar16 + iVar8 + 0x20);
  ...
  uVar6 = (*(code *)PTR_FUN_8c09144c)();
  uVar5 = SUB84(in_xd10,0);
  uVar24 = SUB84(dVar27,0);
  (*(code *)PTR_FUN_8c091450)(uVar6);
  uVar6 = (*(code *)PTR_FUN_8c09144c)();
  (*(code *)PTR_FUN_8c0915d4)(uVar6);
  puVar4 = PTR_FUN_8c091854;
  puVar3 = PTR_FUN_8c0915d4;
  if ((uVar14 & 7) == 0) {
LAB_8c09147c:
    if ((uVar14 & 0xf) != 0) {
          ...
          if ((*(int *)((int)puVar16 + iVar8 + 0x78) < 0x10) ||
            ...
            if (cVar1 == '\0') {
              if (in_FPSCR_SZ == '\0') {
                ...
                dVar25 = (double)CONCAT44(PTR_FUN_8c091854,DAT_8c091850);
              }
              if (in_FPSCR_SZ == '\0') {
