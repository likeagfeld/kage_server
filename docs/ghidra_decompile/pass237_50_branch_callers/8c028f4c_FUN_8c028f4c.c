// entry: 8c028f4c
// name: FUN_8c028f4c
// signature: undefined FUN_8c028f4c(void)
  ...
  if (iVar9 < *(int *)(DAT_8c0290e2 + param_2)) {
    ...
    do {
      ...
      *(undefined2 *)(param_2 + iVar3 + iVar9 * 2) = 0;
      puVar1 = PTR_FUN_8c0290f8;
      *(int *)(iVar14 + param_2) = iVar9;
      (*(code *)puVar1)(param_2 + iVar4 + iVar9 * 2,6);
      (*(code *)PTR_FUN_8c029264)(*(uint *)((int)puVar15 + -0x24) & 0xffff,(int)DAT_8c029256);
      (*(code *)PTR_FUN_8c029264)(*(uint *)((int)puVar15 + -0x28) & 0xffff,6);
      (*(code *)PTR_FUN_8c029264)(*(uint *)((int)puVar15 + -0x24) & 0xffff,(int)DAT_8c029256);
