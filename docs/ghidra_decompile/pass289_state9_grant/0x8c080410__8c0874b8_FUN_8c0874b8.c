// PTR slot:    0x8c080410
// resolved to: 8c0874b8
// containing:  FUN_8c0874b8 @ 8c0874b8 (size 1756)
// signature: undefined FUN_8c0874b8(void)
// direct callers (refs to entry):
//   8c080360@FUN_8c07f510/8c07f510
// callers via ptr slot:
//   8c08035c@FUN_8c07f510/8c07f510
...

{
  ...
  *(int *)((int)puVar16 + -0x10) = param_4;
  ...
  if (iVar4 == 0) {
    ...
    puVar3 = PTR___bfswu_8c0877ac;
    puVar2 = PTR___divlu_8c0877a8;
...
LAB_8c0876a2:
  ...
  puVar3 = PTR___bfswu_8c087b3c;
  puVar2 = PTR___divlu_8c087b38;
