// PTR slot:    0x8c08040c
// resolved to: 8c0856f0
// containing:  FUN_8c0856f0 @ 8c0856f0 (size 1794)
// signature: undefined FUN_8c0856f0(void)
// direct callers (refs to entry):
//   8c0852b6@FUN_8c085170/8c085170
//   8c085418@FUN_8c085170/8c085170
//   8c07e180@FUN_8c07dd36/8c07dd36
//   8c07ea20@FUN_8c07e2fc/8c07e2fc
//   8c07ebd4@FUN_8c07e2fc/8c07e2fc
//   8c0803ec@FUN_8c07f510/8c07f510
//   8c080354@FUN_8c07f510/8c07f510
//   8c080ade@FUN_8c080790/8c080790
//   8c07bd64@FUN_8c07b7a0/8c07b7a0
// callers via ptr slot:
//   8c08034e@FUN_8c07f510/8c07f510
//   8c0803e6@FUN_8c07f510/8c07f510
...

{
  ...
  *(undefined4 *)((int)puVar15 + -0x34) = 0;
  (*(code *)PTR___bfswu_8c085908)(*(undefined4 *)((int)puVar15 + -0x44));
  ...
  *(undefined1 **)((int)puVar15 + -0x24) = (undefined1 *)((int)puVar15 + -0x60);
  ...
  uVar18 = (*(code *)PTR___divlu_8c085a88)();
  uVar5 = SUB84(in_xd10,0);
  uVar23 = SUB84(dVar25,0);
  (*(code *)PTR___bfswu_8c085a8c)(uVar18);
  uVar18 = (*(code *)PTR___divlu_8c085a88)();
  (*(code *)PTR___bfswu_8c085a8c)(uVar18);
  puVar4 = PTR___bfswu_8c085e7c;
  puVar3 = PTR___bfswu_8c085c04;
  if ((uVar13 & 7) == 0) {
LAB_8c085ab0:
      ...
      if ((**(char **)(*(int *)((int)puVar15 + -0x1c) + 4) == '\x04') &&
        ...
        if (*(short *)(*(int *)(*(int *)((int)puVar15 + -0x1c) + 8) + 0x18) == 0) {
          if (in_FPSCR_SZ == '\0') {
            ...
            uVar27 = CONCAT44(PTR___bfswu_8c085e7c,DAT_8c085e74._4_4_);
          }
        }
        else if (in_FPSCR_SZ == '\0') {
...
LAB_8c085d34:
  ...
  if (cVar1 == '\0') {
    ...
    if (in_FPSCR_SZ == '\0') {
      ...
      *(ulonglong *)((int)puVar15 + -0xc) = CONCAT44(PTR___bfswu_8c085e7c,DAT_8c085e74._4_4_);
    }
  }
  else if (cVar1 == 'g') {
    if (in_FPSCR_SZ == '\0') {
