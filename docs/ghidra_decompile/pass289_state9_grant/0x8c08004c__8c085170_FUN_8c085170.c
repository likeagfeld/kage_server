// PTR slot:    0x8c08004c
// resolved to: 8c085170
// containing:  FUN_8c085170 @ 8c085170 (size 1244)
// signature: undefined FUN_8c085170(void)
// direct callers (refs to entry):
//   8c08f95e@FUN_8c08f6d8/8c08f6d8
//   8c08f79c@FUN_8c08f6d8/8c08f6d8
//   8c085174@FUN_8c085170/8c085170
//   8c084da4@FUN_8c084d9c/8c084d9c
//   8c040e74@FUN_8c040bca/8c040bca
//   8c07feb6@FUN_8c07f510/8c07f510
//   8c07fca2@FUN_8c07f510/8c07f510
// callers via ptr slot:
//   8c07feb4@FUN_8c07f510/8c07f510
...

{
  ...
  if (((uVar6 != 0) && (uVar6 != 1)) && (uVar6 != 2)) {
    if (((((uVar6 == 3) || (uVar6 == 4)) || ((uVar6 == 5 || ((uVar6 == 6 || (uVar6 == 7)))))) ||
      ...
      iVar5 = (*(code *)PTR___bfxbu_8c085620)(param_4 + 9);
    ...
    if (uVar6 == 0xb) {
      if (*(char *)((int)DAT_8c08547a + *(int *)(param_2 + 4)) == '\x01') {
        iVar5 = (*(code *)PTR___bfxbu_8c085480)(param_4,&DAT_8c2856fc);
        iVar9 = *(int *)(param_2 + 0x10);
      ...
      *(char *)(iVar10 + 0x1b) = (char)*(undefined2 *)(param_4 + 4);
      iVar5 = (*(code *)PTR__rand_8c085488)();
      puVar4 = PTR___bfxbu_8c085480;
      if (in_FPSCR_PR == '\0') {
...
LAB_8c085228:
  puVar4 = PTR___bfxbu_8c085300;
  if (*(char *)(param_4 + 10) != '\v') {
    if (*(char *)((int)DAT_8c0852f6 + *(int *)(param_2 + 4)) == '\x01') {
      iVar5 = (*(code *)PTR___bfxbu_8c085300)(param_4 + 9);
      iVar9 = *(int *)(param_2 + 0x10);
      if (((*(short *)(iVar9 + iVar5 * 0x1e + 0x16) != 0) ||
