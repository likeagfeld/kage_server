// query addr: 0x8c098ddc
// containing entry: 8c098920
// name: FUN_8c098920
...

{
  ...
  (*(code *)PTR__memset_8c0989c8)((int)&local_10 + iVar1,0,8);
  ...
  *(ushort *)((int)&local_10 + iVar1) =
  ...
  (*(code *)PTR___bfswu_8c0989d0)(uVar2);
  (*(code *)PTR___bfswu_8c0989d0)(*(undefined4 *)(DAT_8c0989bc + param_1));
