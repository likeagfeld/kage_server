// query addr: 0x8C09B170
// containing entry: 8c09b170
// name: FUN_8c09b170
...

{
  ...
  (*(code *)PTR__memset_8c09b2b0)((int)&local_14 + iVar3,0,0x40);
  puVar2 = PTR___bfswu_8c09b2b8;
  ...
  *(ushort *)((int)&local_14 + iVar3) =
  ...
  (*(code *)PTR___bfswu_8c09b2b8)(uVar5);
  ...
  *(int *)((int)&local_14 + DAT_8c09b29c + iVar3) = (int)&local_14 + iVar3;
  ...
  (*(code *)puVar2)();
LAB_8c09b1f6:
  (*(code *)PTR__memcpy_8c09b2bc)(*(int *)((int)&local_14 + DAT_8c09b29c + iVar3) + 4,iVar8,0x20);
