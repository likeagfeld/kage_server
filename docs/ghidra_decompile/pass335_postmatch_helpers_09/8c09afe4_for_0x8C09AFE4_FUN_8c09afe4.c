// query addr: 0x8C09AFE4
// containing entry: 8c09afe4
// name: FUN_8c09afe4
...

{
  ...
  (*(code *)PTR__memset_8c09b158)((int)&local_1c + iVar3,0,(int)DAT_8c09b134);
  puVar2 = PTR___bfswu_8c09b160;
  ...
  *(ushort *)((int)&local_1c + iVar3) =
  ...
  (*(code *)PTR___bfswu_8c09b160)(uVar7);
  ...
  *(int *)((int)&local_1c + DAT_8c09b142 + iVar3) = (int)&local_1c + iVar3;
  ...
  (*(code *)puVar2)();
LAB_8c09b07a:
  puVar2 = PTR__memcpy_8c09b164;
  (*(code *)PTR__memcpy_8c09b164)(*(int *)((int)&local_1c + DAT_8c09b142 + iVar3) + 4,iVar9,0x20);
