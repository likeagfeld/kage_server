...

{
  ...
  if (*param_2 == '\0') {
    (**(code **)(*(int *)(param_1 + 0x28) + 0x68))
              (param_1 + *(int *)(*(int *)(param_1 + 0x28) + 0x60),_DAT_8c0eacf0,*param_3);
    iVar1 = *param_3;
    iVar2 = *_DAT_8c0eacf4;
...
LAB_8c0eabf2:
    if (piVar3 == (int *)0x0) {
      ...
      (*(code *)PTR_FUN_8c0ead04)(*_DAT_8c0eacf4 + 0x3c,0,0);
    }
    else {
      iVar1 = param_3[1];
      if (iVar1 == _DAT_8c0eacf8) {
        piVar3[2] = param_3[2];
      }
      else if (iVar1 == _DAT_8c0eacfc) {
        (*(code *)PTR_FUN_8c0ead08)();
      }
      else if (iVar1 == _DAT_8c0ead00) {
        piVar3[1] = param_3[2];
      }
      (*(code *)PTR_FUN_8c0ead04)(*_DAT_8c0eacf4 + 0x3c,0xe,0);
    }
  }
  else {
    (**(code **)(*(int *)(param_1 + 0x28) + 0x68))
    ...
    (*(code *)PTR_FUN_8c0ead04)(*_DAT_8c0eacf4 + 0x3c,0xf,0);
    *(int *)(*_DAT_8c0eacf4 + 0x50) = param_3[1];
  }
  return;
}
