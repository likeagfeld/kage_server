// entry: 8c04361c
// name: FUN_8c04361c
// signature: undefined FUN_8c04361c(void)


/* WARNING: Removing unreachable block (ram,0x8c04383e) */

void FUN_8c04361c(undefined4 param_1,double param_2,undefined4 param_3,int param_4)

{
  ...
  if (in_FPSCR_SZ == '\0') {
    uStack_c = (double)CONCAT44((int)((ulonglong)in_dr12 >> 0x20),(undefined4)uStack_c);
