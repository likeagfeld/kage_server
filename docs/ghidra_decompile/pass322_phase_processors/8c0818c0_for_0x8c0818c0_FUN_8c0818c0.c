// query addr: 0x8c0818c0
// containing entry: 8c0818c0
// name: FUN_8c0818c0
...

{
  ...
  *(undefined4 *)((int)puVar19 + iVar8 + 0x50) = 1;
  ...
  if (cVar1 == '\x02') {
    ...
    uVar13 = (undefined4)in_dr14;
    iVar5 = (*(code *)PTR___modlu_8c081b94)();
    iVar16 = *(int *)(iVar16 + 4);
        ...
        if (0 < *(int *)((int)puVar19 + iVar8 + 0x5c)) {
          ...
          do {
            *(int *)((int)puVar19 + (int)DAT_8c0820de + iVar8 + -4) = iVar16 + 1;
            ...
            puVar4 = PTR___bfswu_8c08285c;
            puVar3 = PTR___bfswu_8c082250;
            bVar10 = false;
