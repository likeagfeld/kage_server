  ...
  do {
    ...
    if (*(char *)(param_1 + 0x3e + iVar6) == '\0') {
      ...
      if (iVar8 != 0) {
        ...
        (*(code *)PTR___bfswu_8c0763ec)(uVar2);
        (*(code *)PTR___bfswu_8c0763ec)(-(((*pbVar12 & 0x10) == 0) - 1),(int)DAT_8c0763d8);
        (*(code *)PTR___bfswu_8c0763ec)(*pbVar12 & 0xf,(int)DAT_8c0763da);
          ...
          if (*(int *)(DAT_8c076540 + param_1) == 0) {
            ...
            *(undefined **)(&stack0xfffffff8 + iVar4) =
            ...
            if (iVar5 != 0) {
              ...
              (*(code *)PTR__vsprintf_8c07655c)(&stack0xfffffffc + iVar4,puVar7);
