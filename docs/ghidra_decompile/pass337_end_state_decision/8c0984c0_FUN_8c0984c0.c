...

{
  ...
  (*(code *)PTR__memset_8c098594)((int)&local_14 + iVar1,0,(int)DAT_8c098582);
  ...
  *(ushort *)((int)&local_14 + iVar1) =
  ...
  (*(code *)PTR___bfswu_8c0985a4)(uVar3);
  (*(code *)PTR___bfswu_8c0985a4)(*(undefined4 *)(DAT_8c09858a + param_1));
  (*(code *)PTR__memcpy_8c09859c)
