// entry: 8c076338
// name: FUN_8c076338
// signature: undefined FUN_8c076338(void)


/* WARNING: Removing unreachable block (ram,0x8c07641e) */

void FUN_8c076338(undefined *param_1)

{
  ...
  while( true ) {
    ...
    *(undefined1 *)(unaff_r12 + 2) = *(undefined1 *)(unaff_r10 + 8);
          ...
          if (*(int *)(DAT_8c0763e0 + iVar3) != 0 || *(int *)(DAT_8c0763e2 + iVar3) != 0) {
            ...
            if (*(int *)(DAT_8c076540 + unaff_r8) == 0) {
              ...
              if (*(int *)PTR_DAT_8c076554 != 0) {
                (*(code *)PTR__vsprintf_8c07655c)(&stack0x0000001c,&stack0x0000001c);
    ...
    (*(code *)PTR___bfswu_8c0763ec)(uVar2);
    uVar2 = (*(code *)puVar1)((int)DAT_8c0763d6);
    (*(code *)PTR___bfswu_8c0763ec)(uVar2);
    (*(code *)PTR___bfswu_8c0763ec)(-(((*pbVar6 & 0x10) == 0) - 1),(int)DAT_8c0763d8);
    (*(code *)PTR___bfswu_8c0763ec)(*pbVar6 & 0xf,(int)DAT_8c0763da);
