...

{
  ...
  if ((-1 < *(int *)(DAT_8c098254 + param_1)) &&
    ...
    (*(code *)PTR__memset_8c098270)((int)&local_8 + iVar1,0,0xd);
    ...
    *(ushort *)((int)&local_8 + iVar1) =
    ...
    (*(code *)PTR___bfswu_8c098274)(*(undefined4 *)(DAT_8c09825e + param_1));
    (*(code *)PTR__memmove_8c09827c)
              (&stack0xfffffffc + iVar1,*(undefined4 *)(DAT_8c098260 + param_1),9);
