...

{
  ...
  (*(code *)PTR___bfswu_8c0766a8)(uVar2,6);
  uVar2 = (*(code *)PTR_FUN_8c076698)((int)DAT_8c076688);
  (*(code *)PTR___bfswu_8c0766a8)(uVar2,(int)DAT_8c076688);
  (*(code *)PTR___bfswu_8c0766a8)(-(((param_6 & 0x10) == 0) - 1),(int)DAT_8c076692);
  (*(code *)PTR___bfswu_8c0766a8)(param_6 & 0xf,(int)DAT_8c076694);
