...

{
  ...
  *local_30 = *local_34;
  ...
  do {
    ...
    puVar5 = PTR__memcpy_8c09a77c;
    puVar4 = PTR_FUN_8c09a778;
    puVar3 = PTR__memcpy_8c09a5f0;
    ...
    if ((iVar7 == 1) || (iVar7 == 2)) {
      ...
      if (bVar1) {
        ...
        (*(code *)PTR___slow_strcpy_8c09a608)(puStack_20 + iStack_2c * 0x22 + 2);
      }
    }
    else if (iVar7 == 3) {
      cVar11 = cVar11 + '\x01';
      ...
      if (bVar1) {
        ...
        (*(code *)PTR___slow_strcpy_8c09a794)(iStack_2c);
      }
    }
    else {
