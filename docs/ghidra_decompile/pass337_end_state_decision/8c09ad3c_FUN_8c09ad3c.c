...

{
  ...
  (*(code *)PTR__memset_8c09aec0)((int)&local_20 + iVar6,0,(int)DAT_8c09aea2);
  puVar2 = PTR___bfswu_8c09aec8;
  ...
  *(ushort *)((int)&local_20 + iVar6) =
  ...
  (*(code *)PTR___bfswu_8c09aec8)(uVar5);
  ...
  *(undefined4 *)((int)&local_20 + DAT_8c09aeb8 + iVar6) = *(undefined4 *)(pcVar7 + 0x68);
  ...
  (*(code *)PTR___bfswu_8c09afdc)(pcVar7);
LAB_8c09adea:
  iVar8 = 0;
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 == 0) {
        *(ushort *)((int)puVar11 + iVar8 * 6 + 4) =
        ...
        (*(code *)PTR___bfswu_8c09afdc)();
      }
    }
    puVar2 = PTR__memcpy_8c09aed8;
    iVar13 = iVar13 + -1;
    iVar8 = iVar8 + 1;
  } while (iVar13 != 0);
  (*(code *)PTR__memcpy_8c09aed8)
