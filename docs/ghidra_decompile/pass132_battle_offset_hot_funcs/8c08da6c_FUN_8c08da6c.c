...

{
  ...
  local_3c = param_7;
  local_38 = param_8;
  (*(code *)PTR_FUN_8c08dbf0)(param_6 + 0x10);
  dVar17 = uStack_34;
  ...
  (*(code *)PTR_FUN_8c08dbf0)(local_38 & 0xffff);
  ...
  if (param_9 != 0) {
    ...
    if (iVar5 == 5) {
      ...
      iVar5 = (*pcStack_2c)();
      iVar7 = (*pcStack_2c)();
      iVar12 = (*(code *)PTR_FUN_8c08dc00)(iStack_28);
      iVar5 = (*(code *)PTR_FUN_8c08dc00)(iVar5 - iVar7);
      if (iVar5 < iVar12) {
        (*pcStack_2c)();
        (*(code *)PTR_FUN_8c08dd88)();
      }
      else {
        (*pcStack_2c)();
        (*(code *)PTR_FUN_8c08df08)();
      }
      local_6c[0] = *(undefined2 *)(param_6 + 2);
    }
    else {
      (*(code *)PTR_FUN_8c08df0c)(local_6c,param_9,2);
    }
  }
