...

{
  ...
  *(undefined4 *)((int)DAT_8c07cc7c + (int)param_1) = 0;
  ...
  if (*(int *)((int)DAT_8c07cc90 + (int)param_1) != 0) {
    (*(code *)PTR_FUN_8c07cca0)(0,*(int *)((int)puVar16 + -0x18) << 2);
  }
  ...
  if (0 < (int)param_1[0xb]) {
    do {
      (*(code *)PTR_FUN_8c07ce14)(iVar5,0,0x74);
    ...
    if (0 < *(int *)((int)puVar16 + -0x18)) {
      do {
        if ((**(char **)((int)puVar16 + -0x14) == '`') || (**(char **)((int)puVar16 + -0x14) == '_')
          ...
          *puVar13 = 1;
          puVar13[2] = (short)iVar5;
          puVar2 = PTR_FUN_8c07cfc0;
          (*(code *)PTR_FUN_8c07cfbc)();
          puVar3 = PTR_FUN_8c07cfc4;
          (*(code *)puVar2)();
          (*(code *)puVar3)();
          (*(code *)puVar2)();
          ...
          *(undefined4 *)(puVar13 + 0xc) = 0;
          ...
          if (*pcVar11 == '_') {
            ...
            *(undefined4 *)((int)puVar16 + -8) = *(undefined4 *)(iVar5 + (int)param_1);
            iVar5 = (*(code *)PTR_FUN_8c07cfbc)();
            iVar12 = (*(code *)PTR_FUN_8c07cfc4)();
            iVar14 = iVar5 + iVar12 * uVar6;
            if (*(char *)(iVar14 + *(int *)((int)puVar16 + -8) + -1) == '`') {
              (*(code *)PTR_FUN_8c07cfc8)();
    ...
    if (0 < *(int *)((int)puVar16 + -0x18)) {
      ...
      do {
        ...
        if ((((cVar1 == 'c') || (cVar1 == 'd')) || (cVar1 == 'e')) || (cVar1 == 'f')) {
          *puVar13 = 1;
          puVar13[2] = sVar15;
          puVar2 = PTR_FUN_8c07d2b4;
          (*(code *)PTR_FUN_8c07d2b0)();
          (*(code *)puVar2)();
          (*(code *)PTR_FUN_8c07d2b8)();
          (*(code *)puVar2)();
          *(byte *)(puVar13 + 1) =
    ...
    if (0 < iVar12) {
      ...
      do {
        ...
        if (*pcVar11 == 'g') {
          *puVar13 = 1;
          puVar13[2] = (short)iVar18;
          puVar2 = PTR_FUN_8c07d370;
          (*(code *)PTR_FUN_8c07d36c)();
          (*(code *)puVar2)();
          (*(code *)PTR_FUN_8c07d374)();
          (*(code *)puVar2)();
  ...
  if (cVar1 == '\0') {
    ...
    if (in_FPSCR_SZ == '\0') {
      ...
      *(ulonglong *)(iVar5 + 0x14) = CONCAT44(_LAB_8c07d38c,DAT_8c07d384._4_4_);
    }
  }
  else if (cVar1 == '\x04') {
    if (in_FPSCR_SZ == '\0') {
